...
## R/. Es una funcion de una bibloteca que permite hacer operaciones a todo un vector o matriz, es mejor utilizarlo ya que hace que se puedan hacer operaciones a toda la matriz.
...
## R/. la tecnica se llama broadcasting y hace que el vector mas corto sea de la misma longitud que el vector mas largo.
```{r}
vector_1 <- c(1, 2, 3)
vector_2 <- c(10, 20)

print(resultado <- vector_1 + vector_2)
```
